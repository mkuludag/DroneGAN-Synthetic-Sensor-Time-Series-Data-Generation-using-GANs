...
generated_data = pd.read_csv("test_data/ensemble_gan_data/Egan_['accelerometer_m_s2[0]', 'accelerometer_m_s2[1]', 'accelerometer_m_s2[2]', 'gyro_rad[0]', 'gyro_rad[1]', 'gyro_rad[2]']_4.csv")
...
total_number_of_gan_samples = 10000
...
for i in range(0, total_number_of_gan_samples-window_size + 1, stride):
    ...
    for c, single_item in enumerate(sample_real_data):
        # single_item[0] = generated_data_normalized['gyro_rad[0]'].iloc[d]
        # single_item[1] = generated_data_normalized['gyro_rad[1]'].iloc[d]
        # single_item[2] = generated_data_normalized['gyro_rad[2]'].iloc[d]
        single_item[3] = generated_data_normalized['accelerometer_m_s2[0]'].iloc[d]
        single_item[4] = generated_data_normalized['accelerometer_m_s2[1]'].iloc[d]
        # single_item[5] = generated_data_normalized['accelerometer_m_s2[2]'].iloc[d]
